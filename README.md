...
## Project Description
 > * Stellar Strikers is a 2D Space Shooter in which players are tasked to defend themselves from enemy ships for as long as they can. Enemies come in waves, which each subsequent wave becoming progressively more challenging.
 > * The purpose of this project not only serves as a fun way to put our C++ skills to the test, but also as an opportunity to dip our toes into C++ Game Development.
